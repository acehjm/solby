package me.solby.ifile.csv.service.impl;
...
import me.solby.ifile.csv.exception.CsvException;
import me.solby.ifile.csv.service.CsvWriter;
...
public class CsvWriterImpl implements CsvWriter {
    ...
    @Override
    public <T> ByteArrayOutputStream writeOutputStream(List<T> data, String fileName, Class<T> type) {
        // 校验目标对象注解是否为空
        this.validAnnotation(type);
        // 创建字节输出流
